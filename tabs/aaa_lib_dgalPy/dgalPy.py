...
def optimize(dgalModel,input,minMax,obj,constraints,options):
    ...
    if pyomoModel == False:
        return {"status": {
                    "dgal_status": "dgal constraints == false, no feasible solution",
                    "solver_status": "NA",
                    "termination_condition": "NA"
                    }
        }
    # pdb.set_trace()
